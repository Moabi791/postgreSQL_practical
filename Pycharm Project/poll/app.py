...
NEW_OPTION_PROMPT = "Enter new option text (or leave empty to load from .env file: "
...
def prompt_vote_poll(connection):
    ...
    options_id = int(input("Enter option you'd like to vote for:"))
    username = input("Enter the username you'd like to vote  as: ")
    database.add_poll_vote(connection, username, options_id)
